function [log_p, dlog_p] = negative_log_joint(var_array, y, mc, ms, mc_sq, ms_sq, msc, n_dim, m_dim, d_pts, lambda2_y)
...
%   Negative log joint and gradients for the probabilistic model of CPCA
    ...
    [log_u, A, B] = fixL_unpack_from_var_array(var_array, n_dim, m_dim);
    ...
    if nargout > 1
        ...
        dlog_p = -fixL_pack_to_var_array(dlog_u, dA, dB);
    end
end
